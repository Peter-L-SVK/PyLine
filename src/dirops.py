# ----------------------------------------------------------------
# PyLine 0.9.7 - Directory & File Operations Lib (GPLv3)
...
def original_path(original_dir: str) -> int:
...
def safe_path(original_destination: str) -> None:
...
def default_path(original_destination: str) -> None:
