#----------------------------------------------------------------
# PyLine 0.9.7 - Navigation Manager (GPLv3)
...
class NavigationManager(BaseManager):
    ...
    def __init__(self, hook_utils, display_lines: int = 52):
        super().__init__(hook_utils)
        self.current_line: int = 0
        self.display_start: int = 0
        self.display_lines: int = display_lines
    
    def navigate(self, direction: str, line_count: int, filename: str = None) -> bool:
    ...
    def jump_to_line(self, line_number: int, line_count: int, filename: str = None) -> bool:
    ...
    def jump_to_end(self, line_count: int, filename: str = None) -> bool:
    ...
    def page_up(self, line_count: int, filename: str = None) -> bool:
    ...
    def page_down(self, line_count: int, filename: str = None) -> bool:
        ...
        # Perform page down
        old_line = self.current_line
        new_start = min(line_count - self.display_lines, 
