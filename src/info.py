# ----------------------------------------------------------------
# PyLine 0.9.8 - Info Screen (GPLv3)
...
def print_info() -> None:
    print("\n        #####################################################################")
    print("        # PyLine 0.9.8 for Linux/BSD - Command-line text editor in Python3. #")
...
def print_license_parts(original_destination: str) -> None:
