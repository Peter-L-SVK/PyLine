...
class TextBuffer:
    ...
    def navigate(self, direction: str) -> None:
        ...
        self.navigation_manager.navigate(direction, self.buffer_manager.get_line_count(), self.buffer_manager.filename)

    def jump_to_end(self) -> None:
        """Jump to end of buffer."""
        self.navigation_manager.jump_to_end(self.buffer_manager.get_line_count(), self.buffer_manager.filename)

    def page_up(self) -> None:
        """Move page up."""
        self.navigation_manager.page_up(self.buffer_manager.get_line_count(), self.buffer_manager.filename)

    def page_down(self) -> None:
        """Move page down."""
        self.navigation_manager.page_down(self.buffer_manager.get_line_count(), self.buffer_manager.filename)
    ...
    def start_selection(self) -> None:
        ...
        current_line = self.navigation_manager.get_current_line()
        self.selection_manager.start_selection(current_line, self.buffer_manager.filename)
    ...
    def end_selection(self) -> None:
        ...
        current_line = self.navigation_manager.get_current_line()
        self.selection_manager.end_selection(current_line, self.buffer_manager.filename)
    ...
    def copy_line(self) -> bool:
        ...
        text_to_copy = self.selection_manager.get_selected_text([line_text], self.buffer_manager.filename)
        
        # Fallback: If selection manager returns empty/None/invalid, use the raw line text
        if (not text_to_copy or 
            text_to_copy.strip() == "" or 
            not isinstance(text_to_copy, str)):
    ...
    def copy_selection(self) -> bool:
        ...
        selected_text = self.selection_manager.get_selected_text(self.buffer_manager.lines, self.buffer_manager.filename)
    ...
    def paste_line(self, mode: str = 'insert') -> bool:
        ...
        if len(self.paste_buffer.buffer) == 1:
            paste_text = self.paste_buffer.buffer[0]
    ...
    def display(self) -> None:
        ...
        display_context = {
            ...
            'current_line': self.navigation_manager.current_line,  # ← Use attribute directly
            'action': 'pre_display',
            'operation': 'rendering'
        }
